...
<script>
    ...
    const mapper = {
        ...
        system: {system: '所有系统', finance: '财务系统', property: '物业系统', emergency: '应急调度平台'}
    };
                ...
                formGrid: {
                    ...
                    table: {
                        ...
                        columns: [
                            ...
                            {
                                title: '用户类型', key: 'type', minWidth: 120,
                                fieldFormat: (value) => {
                                   return mapper.type[value];
                                }
                            },
                            {
                                title: '管理系统', key: 'system', minWidth: 120,
                                fieldFormat: (value) => {
                                    return mapper.system[value];
                                }
                            },
